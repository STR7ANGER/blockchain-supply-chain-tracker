# Blockchain Supply-Chain Tracker — Build Plan
...
Event-driven service architecture: Next.js portal; Hono API; Rust smart contract/proof component; Go indexer; PostgreSQL/Prisma; MongoDB for certificates and telemetry.
...
Next.js, TypeScript, shadcn/ui, Redux Toolkit, Hono, Go, Rust, Prisma, PostgreSQL, MongoDB, QR tooling, Docker

## Core domain

Organization, Facility, Product, Batch, Item, CustodyEvent, Shipment, Certificate, Recall, Verification, SustainabilityMetric.

## API strategy

GraphQL for provenance timelines and dashboards; REST for scans/uploads; signed chain commands; webhooks for logistics integrations.
